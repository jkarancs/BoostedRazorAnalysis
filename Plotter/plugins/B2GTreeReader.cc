...
public:
  ...
  void Load_Tree(TFile &f, const char* name = "B2GTTreeMaker/B2GTree") {
    ...
    set_branch_("gen_Mom0ID", &data.gen.MomID, 1);
    ...
    set_branch_("jetAK8_ChargedHadronMultiplicity", &data.jetsAK8.ChargedHadronMultiplicity, 1);
    ...
    set_branch_("jetAK8_neutralHadronMultiplicity", &data.jetsAK8.neutralHadronMultiplicity, 1);
    ...
    set_branch_("evt_TTHadR2", &data.evt.TTHadR2, 0); // Calculate instead
    set_branch_("evt_MR", &data.evt.MR, 1);
    set_branch_("evt_MTR", &data.evt.MTR, 1);
    set_branch_("evt_R", &data.evt.R, 1);
    set_branch_("evt_R2", &data.evt.R2, 0); // Calculate instead
    set_branch_("evt_AK4_MR", &data.evt.AK4_MR, 1);
    set_branch_("evt_AK4_MTR", &data.evt.AK4_MTR, 1);
    set_branch_("evt_AK4_R", &data.evt.AK4_R, 1);
    set_branch_("evt_AK4_R2", &data.evt.AK4_R2, 0); // Calculate instead
    set_branch_("evt_weight", &data.evt.weight, 1);
    if (debug_) std::cout<<"B2GTreeReader: evt loaded"<<std::endl;
    
    set_branch_("evt_RunNumber", &data.evt.RunNumber, 1);
    set_branch_("evt_LumiBlock", &data.evt.LumiBlock, 0);
    set_branch_("evt_EventNumber", &data.evt.EventNumber, 0);
    set_branch_("evt_npv", &data.evt.npv, 1);
    
    set_branch_("vtx_size", &data.evt.vtx_size, 1);
    set_branch_("vtx_z", &data.evt.vtx_z, 1);
    set_branch_("vtx_rho", &data.evt.vtx_rho, 1);
    set_branch_("vtx_chi", &data.evt.vtx_chi, 0);
    set_branch_("vtx_ndof", &data.evt.vtx_ndof, 1);
    
    set_branch_("met_NoHF_Pt", &data.met.Pt, 1);
    set_branch_("met_NoHF_Phi", &data.met.Phi, 1);
    set_branch_("met_NoHF_Px", &data.met.Px, 1);
    set_branch_("met_NoHF_Py", &data.met.Py, 1);
    if (debug_) std::cout<<"B2GTreeReader: met loaded"<<std::endl;
    
    set_branch_("Flag_HBHEIsoNoiseFilterResult", &data.evt.Flag_HBHEIsoNoiseFilterResult, 1);
    set_branch_("Flag_HBHENoiseFilterResult", &data.evt.Flag_HBHENoiseFilterResult, 1);
    set_branch_("Flag_HBHENoiseFilterResultRun1", &data.evt.Flag_HBHENoiseFilterResultRun1, 1);
    set_branch_("Flag_HBHENoiseFilterResultRun2Loose", &data.evt.Flag_HBHENoiseFilterResultRun2Loose, 1);
    set_branch_("Flag_HBHENoiseFilterResultRun2Tight", &data.evt.Flag_HBHENoiseFilterResultRun2Tight, 1);
    set_branch_("Flag_trackingFailureFilter", &data.evt.Flag_trackingFailureFilter, 1);
    set_branch_("Flag_goodVertices", &data.evt.Flag_goodVertices, 1);
    set_branch_("Flag_CSCTightHaloFilter", &data.evt.Flag_CSCTightHaloFilter, 1);
    set_branch_("Flag_trkPOGFilters", &data.evt.Flag_trkPOGFilters, 1);
    set_branch_("Flag_trkPOG_logErrorTooManyClusters", &data.evt.Flag_trkPOG_logErrorTooManyClusters, 1);
    set_branch_("Flag_EcalDeadCellTriggerPrimitiveFilter", &data.evt.Flag_EcalDeadCellTriggerPrimitiveFilter, 1);
    set_branch_("Flag_ecalLaserCorrFilter", &data.evt.Flag_ecalLaserCorrFilter, 1);
    set_branch_("Flag_trkPOG_manystripclus53X", &data.evt.Flag_trkPOG_manystripclus53X, 1);
    set_branch_("Flag_eeBadScFilter", &data.evt.Flag_eeBadScFilter, 1);
    set_branch_("Flag_METFilters", &data.evt.Flag_METFilters, 1);
    set_branch_("Flag_HBHENoiseFilter", &data.evt.Flag_HBHENoiseFilter, 1);
    set_branch_("Flag_trkPOG_toomanystripclus53X", &data.evt.Flag_trkPOG_toomanystripclus53X, 1);
    set_branch_("Flag_hcalLaserEventFilter", &data.evt.Flag_hcalLaserEventFilter, 1);
    ...
    set_branch_("el_PtNearGenTop", &data.ele.PtNearGenTop, 1);
    set_branch_("el_IsPartOfNearAK4Jet", &data.ele.IsPartOfNearAK4Jet, 1);
    set_branch_("el_IsPartOfNearAK8Jet", &data.ele.IsPartOfNearAK8Jet, 1);
    set_branch_("el_IsPartOfNearSubjet", &data.ele.IsPartOfNearSubjet, 1);
    set_branch_("el_LepAK4JetFrac", &data.ele.LepAK4JetFrac, 1);
    set_branch_("el_LepAK8JetFrac", &data.ele.LepAK8JetFrac, 1);
    set_branch_("el_LepSubjetFrac", &data.ele.LepSubjetFrac, 1);
    set_branch_("el_LepAK4JetMassDrop", &data.ele.LepAK4JetMassDrop, 1);
    set_branch_("el_LepAK8JetMassDrop", &data.ele.LepAK8JetMassDrop, 1);
    set_branch_("el_LepSubjetMassDrop", &data.ele.LepSubjetMassDrop, 1);
    set_branch_("el_AK4JetV1DR", &data.ele.AK4JetV1DR, 1);
    set_branch_("el_AK4JetV2DR", &data.ele.AK4JetV2DR, 1);
    set_branch_("el_AK4JetV3DR", &data.ele.AK4JetV3DR, 1);
    set_branch_("el_AK8JetV1DR", &data.ele.AK8JetV1DR, 1);
    set_branch_("el_AK8JetV2DR", &data.ele.AK8JetV2DR, 1);
    set_branch_("el_AK8JetV3DR", &data.ele.AK8JetV3DR, 1);
    set_branch_("el_SubjetV1DR", &data.ele.SubjetV1DR, 1);
    set_branch_("el_SubjetV2DR", &data.ele.SubjetV2DR, 1);
    set_branch_("el_SubjetV3DR", &data.ele.SubjetV3DR, 1);
    set_branch_("el_AK4JetV1PtRel", &data.ele.AK4JetV1PtRel, 1);
    set_branch_("el_AK4JetV2PtRel", &data.ele.AK4JetV2PtRel, 1);
    set_branch_("el_AK4JetV3PtRel", &data.ele.AK4JetV3PtRel, 1);
    set_branch_("el_AK8JetV1PtRel", &data.ele.AK8JetV1PtRel, 1);
    set_branch_("el_AK8JetV2PtRel", &data.ele.AK8JetV2PtRel, 1);
    set_branch_("el_AK8JetV3PtRel", &data.ele.AK8JetV3PtRel, 1);
    set_branch_("el_SubjetV1PtRel", &data.ele.SubjetV1PtRel, 1);
    set_branch_("el_SubjetV2PtRel", &data.ele.SubjetV2PtRel, 1);
    set_branch_("el_SubjetV3PtRel", &data.ele.SubjetV3PtRel, 1);
    ...
    set_branch_("mu_PtNearGenTop", &data.mu.PtNearGenTop, 1);
    set_branch_("mu_IsPartOfNearAK4Jet", &data.mu.IsPartOfNearAK4Jet, 1);
    set_branch_("mu_IsPartOfNearAK8Jet", &data.mu.IsPartOfNearAK8Jet, 1);
    set_branch_("mu_IsPartOfNearSubjet", &data.mu.IsPartOfNearSubjet, 1);
    set_branch_("mu_LepAK4JetFrac", &data.mu.LepAK4JetFrac, 1);
    set_branch_("mu_LepAK8JetFrac", &data.mu.LepAK8JetFrac, 1);
    set_branch_("mu_LepSubjetFrac", &data.mu.LepSubjetFrac, 1);
    set_branch_("mu_LepAK4JetMassDrop", &data.mu.LepAK4JetMassDrop, 1);
    set_branch_("mu_LepAK8JetMassDrop", &data.mu.LepAK8JetMassDrop, 1);
    set_branch_("mu_LepSubjetMassDrop", &data.mu.LepSubjetMassDrop, 1);
    set_branch_("mu_AK4JetV1DR", &data.mu.AK4JetV1DR, 1);
    set_branch_("mu_AK4JetV2DR", &data.mu.AK4JetV2DR, 1);
    set_branch_("mu_AK4JetV3DR", &data.mu.AK4JetV3DR, 1);
    set_branch_("mu_AK8JetV1DR", &data.mu.AK8JetV1DR, 1);
    set_branch_("mu_AK8JetV2DR", &data.mu.AK8JetV2DR, 1);
    set_branch_("mu_AK8JetV3DR", &data.mu.AK8JetV3DR, 1);
    set_branch_("mu_SubjetV1DR", &data.mu.SubjetV1DR, 1);
    set_branch_("mu_SubjetV2DR", &data.mu.SubjetV2DR, 1);
    set_branch_("mu_SubjetV3DR", &data.mu.SubjetV3DR, 1);
    set_branch_("mu_AK4JetV1PtRel", &data.mu.AK4JetV1PtRel, 1);
    set_branch_("mu_AK4JetV2PtRel", &data.mu.AK4JetV2PtRel, 1);
    set_branch_("mu_AK4JetV3PtRel", &data.mu.AK4JetV3PtRel, 1);
    set_branch_("mu_AK8JetV1PtRel", &data.mu.AK8JetV1PtRel, 1);
    set_branch_("mu_AK8JetV2PtRel", &data.mu.AK8JetV2PtRel, 1);
    set_branch_("mu_AK8JetV3PtRel", &data.mu.AK8JetV3PtRel, 1);
    set_branch_("mu_SubjetV1PtRel", &data.mu.SubjetV1PtRel, 1);
    set_branch_("mu_SubjetV2PtRel", &data.mu.SubjetV2PtRel, 1);
    set_branch_("mu_SubjetV3PtRel", &data.mu.SubjetV3PtRel, 1);
