...
# Cards
python scripts/run_syst.py -d "results/run_"$date1"_syst" -m $model -b WAna_nj45 --test=1
python scripts/run_syst.py -d "results/run_"$date1"_syst" -m $model -b WAna_nj6 --test=1
python scripts/run_syst.py -d "results/run_"$date2"_syst_TopAna" -m $model -b TopAna --test=1
