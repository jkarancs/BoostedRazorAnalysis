...
void selectVariables(itreestream& stream, DataStruct& data) {
  ...
  //sys stream.select("jetAK4Puppi_jecFactor0", data.jetsAK4Puppi.jecFactor0);
  //sys stream.select("jetAK4Puppi_jecUncertainty", data.jetsAK4Puppi.jecUncertainty);
  //sys stream.select("jetAK4Puppi_JERSF", data.jetsAK4Puppi.JERSF);
  //sys stream.select("jetAK4Puppi_JERSFUp", data.jetsAK4Puppi.JERSFUp);
  //sys stream.select("jetAK4Puppi_JERSFDown", data.jetsAK4Puppi.JERSFDown);
  //sys stream.select("jetAK4Puppi_SmearedPt", data.jetsAK4Puppi.SmearedPt);
  ...
  //sys stream.select("jetAK8Puppi_jecFactor0", data.jetsAK8Puppi.jecFactor0);
  //sys stream.select("jetAK8Puppi_jecUncertainty", data.jetsAK8Puppi.jecUncertainty);
  //sys stream.select("jetAK8Puppi_JERSF", data.jetsAK8Puppi.JERSF);
  ...
  //sys stream.select("jetAK8Puppi_SmearedPt", data.jetsAK8Puppi.SmearedPt);
