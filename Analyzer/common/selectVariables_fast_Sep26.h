...
void selectVariables(itreestream& stream, DataStruct& data) {
  ...
  //sys stream.select("jetAK4CHS_jecFactor0", data.jetsAK4.jecFactor0);
  //sys stream.select("jetAK4CHS_jecUncertainty", data.jetsAK4.jecUncertainty);
  ...
  //sys stream.select("jetAK8CHS_jecFactor0", data.jetsAK8.jecFactor0);
  //sys stream.select("jetAK8CHS_jecUncertainty", data.jetsAK8.jecUncertainty);
