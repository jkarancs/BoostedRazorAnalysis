...
void selectVariables(itreestream& stream, DataStruct& data) {
  ...
  stream.select("evt_NISRJets", data.evt.NISRJets);
  ...
  stream.select("met_genPt", data.met.genPt);
  stream.select("met_genPhi", data.met.genPhi);
  ...
  stream.select("Flag_isPathologicalFastsimEvent", data.filter.isPathologicalFastsimEvent);
  ...
  stream.select("HLT_Photon22", data.hlt.Photon22);
  stream.select("HLT_Photon22_prescale", data.hlt.Photon22_prescale);
  stream.select("HLT_Photon30", data.hlt.Photon30);
  stream.select("HLT_Photon30_prescale", data.hlt.Photon30_prescale);
  stream.select("HLT_Photon36", data.hlt.Photon36);
  stream.select("HLT_Photon36_prescale", data.hlt.Photon36_prescale);
  stream.select("HLT_Photon50", data.hlt.Photon50);
  stream.select("HLT_Photon50_prescale", data.hlt.Photon50_prescale);
  stream.select("HLT_Photon75", data.hlt.Photon75);
  stream.select("HLT_Photon75_prescale", data.hlt.Photon75_prescale);
  stream.select("HLT_Photon90", data.hlt.Photon90);
  stream.select("HLT_Photon90_prescale", data.hlt.Photon90_prescale);
  stream.select("HLT_Photon120", data.hlt.Photon120);
  stream.select("HLT_Photon120_prescale", data.hlt.Photon120_prescale);
  stream.select("HLT_Photon165_HE10", data.hlt.Photon165_HE10);
  stream.select("HLT_Photon165_HE10_prescale", data.hlt.Photon165_HE10_prescale);
  stream.select("HLT_Photon175", data.hlt.Photon175);
  stream.select("HLT_Photon175_prescale", data.hlt.Photon175_prescale);
  stream.select("HLT_Photon250_NoHE", data.hlt.Photon250_NoHE);
  stream.select("HLT_Photon250_NoHE_prescale", data.hlt.Photon250_NoHE_prescale);
  stream.select("HLT_Photon300_NoHE", data.hlt.Photon300_NoHE);
  stream.select("HLT_Photon300_NoHE_prescale", data.hlt.Photon300_NoHE_prescale);
  stream.select("HLT_Photon500", data.hlt.Photon500);
  stream.select("HLT_Photon500_prescale", data.hlt.Photon500_prescale);
  stream.select("HLT_Photon600", data.hlt.Photon600);
  stream.select("HLT_Photon600_prescale", data.hlt.Photon600_prescale);
  ...
  stream.select("pho_ChargedHadronIsoEAcorrectedsp15", data.pho.ChargedHadronIsoEAcorrectedsp15);
  ...
  //stream.select("mu_Iso04db", data.mu.Iso04);
  ...
  stream.select("tau_size", data.tau.size);
  stream.select("tau_IsLoose", data.tau.IsLoose);
  //stream.select("tau_IsMedium", data.tau.IsMedium);
  //stream.select("tau_IsTight", data.tau.IsTight);
  //stream.select("tau_passEleVetoLoose", data.tau.passEleVetoLoose);
  //stream.select("tau_passEleVetoMedium", data.tau.passEleVetoMedium);
  //stream.select("tau_passEleVetoTight", data.tau.passEleVetoTight);
  //stream.select("tau_passMuVetoLoose", data.tau.passMuVetoLoose);
  //stream.select("tau_passMuVetoTight", data.tau.passMuVetoTight);
  //stream.select("tau_ID", data.tau.ID);
  ...
  //stream.select("tau_puCorrPtSum", data.tau.puCorrPtSum);
  //stream.select("tau_isoMVAnewDMwLT", data.tau.isoMVAnewDMwLT);
  //stream.select("tau_leadCandPt", data.tau.leadCandPt);
  //stream.select("tau_leadCandID", data.tau.leadCandID);
  //stream.select("tau_leadChargedHadrCandPt", data.tau.leadChargedHadrCandPt);
  //stream.select("tau_leadChargedHadrCandID", data.tau.leadChargedHadrCandID);
