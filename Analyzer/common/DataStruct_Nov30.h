...
public:
  ...
  public:
    ...
    std::vector<float> ChargedHadronIsoEAcorrectedsp15;
    ...
    void init() {
      ...
      init_vec(ChargedHadronIsoEAcorrectedsp15);
  ...
  public:
    ...
    unsigned int size;
    std::vector<int> IsLoose;
    std::vector<int> IsMedium;
    std::vector<int> IsTight;
    std::vector<int> passEleVetoLoose;
    std::vector<int> passEleVetoMedium;
    std::vector<int> passEleVetoTight;
    std::vector<int> passMuVetoLoose;
    std::vector<int> passMuVetoTight;
    std::vector<int> ID;
    std::vector<int> eleVetoCategory;
    std::vector<float> eleVetoMVA;
    std::vector<float> E;
    std::vector<float> Pt;
    std::vector<float> Eta;
    std::vector<float> Phi;
    std::vector<float> combinedIsoDeltaBetaCorr3Hits;
    std::vector<float> chargedIsoPtSum;
    std::vector<float> neutralIsoPtSum;
    std::vector<float> puCorrPtSum;
    std::vector<float> isoMVAnewDMwLT;
    std::vector<float> leadCandPt;
    std::vector<float> leadCandID;
    std::vector<float> leadChargedHadrCandPt;
    std::vector<float> leadChargedHadrCandID;
    ...
    void init() {
      ...
      init_vec(IsMedium);
      init_vec(IsTight);
      init_vec(passEleVetoLoose);
      init_vec(passEleVetoMedium);
      init_vec(passEleVetoTight);
      init_vec(passMuVetoLoose);
      init_vec(passMuVetoTight);
      init_vec(ID);
      init_vec(eleVetoCategory);
      init_vec(eleVetoMVA);
      init_vec(E);
      init_vec(Pt);
      init_vec(Eta);
      init_vec(Phi);
      init_vec(combinedIsoDeltaBetaCorr3Hits);
      init_vec(chargedIsoPtSum);
      init_vec(neutralIsoPtSum);
      init_vec(puCorrPtSum);
      init_vec(isoMVAnewDMwLT);
      init_vec(leadCandPt);
      init_vec(leadCandID);
      init_vec(leadChargedHadrCandPt);
      init_vec(leadChargedHadrCandID);
    }
