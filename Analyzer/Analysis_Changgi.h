...
bool isT5ttcc = TString(sample).Contains("T5ttcc");
  ...
  analysis_cuts['U'].push_back({ .name="3Jet",       .func = []    { return nJet>=3;                          }});
  //analysis_cuts['U'].push_back({ .name="MR_R2",      .func = [&d]  { return d.evt.MR>=800 && d.evt.R2>=0.08;  }});
  analysis_cuts['U'].push_back({ .name="HLT",   .func = [this,&d]  { return isData ? d.hlt.AK8PFJet450==1 || d.hlt.PFHT800==1 || d.hlt.PFHT900==1 : 1; }});
  analysis_cuts['U'].push_back({ .name="0Ele",       .func = []    { return nEleVeto==0;                      }});
  analysis_cuts['U'].push_back({ .name="0Mu",        .func = []    { return nMuVeto==0;                       }});
  analysis_cuts['U'].push_back({ .name="0IsoTrk",    .func = [&d]  { return d.evt.NIsoTrk==0;                 }});
  analysis_cuts['U'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
  analysis_cuts['U'].push_back({ .name="1mW",        .func = []    { return nWMassTag>=1;                     }});
  analysis_cuts['U'].push_back({ .name="mDPhi",	     .func = []    { return minDeltaPhi<0.3;                  }});

  // W boson anti tag fake rate
  analysis_cuts['I'].push_back({ .name="3Jet",       .func = []    { return nJet>=3;                          }});
  //analysis_cuts['I'].push_back({ .name="MR_R2",      .func = [&d]  { return d.evt.MR>=800 && d.evt.R2>=0.08;  }});
  analysis_cuts['I'].push_back({ .name="HLT",   .func = [this,&d]  { return isData ? d.hlt.AK8PFJet450==1 || d.hlt.PFHT800==1 || d.hlt.PFHT900==1 : 1; }});
  analysis_cuts['I'].push_back({ .name="0Ele",       .func = []    { return nEleVeto==0;                      }});
  analysis_cuts['I'].push_back({ .name="0Mu",        .func = []    { return nMuVeto==0;                       }});
  analysis_cuts['I'].push_back({ .name="0IsoTrk",    .func = [&d]  { return d.evt.NIsoTrk==0;                 }});
  analysis_cuts['I'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
  analysis_cuts['I'].push_back({ .name="1aW",        .func = []    { return nTightWAntiTag>=1;                }});
  analysis_cuts['I'].push_back({ .name="InvmDPhi0p3",.func = []    { return minDeltaPhi<0.3;                  }});

  // Top quark tag fake rate
  analysis_cuts['H'].push_back({ .name="3Jet",       .func = []    { return nJet>=3;                          }});
  //analysis_cutsH'Y'].push_back({ .name="MR_R2",      .func = [&d]  { return d.evt.MR>=800 && d.evt.R2>=0.08;  }});
  ...
  analysis_cuts['H'].push_back({ .name="0IsoTrk",    .func = [&d]  { return d.evt.NIsoTrk==0;                 }});
  analysis_cuts['H'].push_back({ .name="1Top",       .func = []    { return nHadTopTag>=1;                    }});
  analysis_cuts['H'].push_back({ .name="InvmDPhi0p3",.func = []    { return minDeltaPhi<0.3;                  }});

  // Top quark mass tag fake rate
  analysis_cuts['J'].push_back({ .name="3Jet",       .func = []    { return nJet>=3;                          }});
  //analysis_cutsJ'U'].push_back({ .name="MR_R2",      .func = [&d]  { return d.evt.MR>=800 && d.evt.R2>=0.08;  }});
  analysis_cuts['J'].push_back({ .name="HLT",   .func = [this,&d]  { return isData ? d.hlt.AK8PFJet450==1 || d.hlt.PFHT800==1 || d.hlt.PFHT900==1 : 1; }});
  analysis_cuts['J'].push_back({ .name="0Ele",       .func = []    { return nEleVeto==0;                      }});
  analysis_cuts['J'].push_back({ .name="0Mu",        .func = []    { return nMuVeto==0;                       }});
  analysis_cuts['J'].push_back({ .name="0IsoTrk",    .func = [&d]  { return d.evt.NIsoTrk==0;                 }});
  analysis_cuts['J'].push_back({ .name="1m0bTop",    .func = []    { return nHadTop0BMassTag>=1;              }});
  analysis_cuts['J'].push_back({ .name="mDPhi",	     .func = []    { return minDeltaPhi<0.3;                  }});
...
Analysis::apply_scale_factors(DataStruct& data, const unsigned int& s, const std::vector<std::vector<double> >& nSigmaSFs)
{
  ...
  scale_factors['I'].push_back(sf_btag_loose);
...
TH1D* h_AK8Jet1Pt_diffBin_GenW_W;
TH1D* h_AK8Jet1Pt_diffBin_GenW_no_W;
TH1D* h_AK8Jet1Pt_diffBin_GenTop_Top;
TH1D* h_AK8Jet1Pt_diffBin_GenTop_no_Top;
...
Analysis::init_analysis_histos(const unsigned int& syst_nSyst, const unsigned int& syst_index)
{
 ...
 // double htmx = 1500;
  ...
  h_ht_AK4_S_nj35 = new TH1D("ht_AK4_S_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_S_nj35 = new TH1D("ht_AK8_S_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_S_nj6 = new TH1D("ht_AK4_S_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_S_nj6 = new TH1D("ht_AK8_S_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_Z = new TH1D("ht_AK4_Z",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_Z = new TH1D("ht_AK8_Z",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_Z_nj35 = new TH1D("ht_AK4_Z_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_Z_nj35 = new TH1D("ht_AK8_Z_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_Z_nj6 = new TH1D("ht_AK4_Z_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_Z_nj6 = new TH1D("ht_AK8_Z_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nodPhi_Q = new TH1D("ht_AK4_nodPhi_Q",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nodPhi_Q = new TH1D("ht_AK8_nodPhi_Q",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_notau21_Q = new TH1D("ht_AK4_notau21_Q",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_notau21_Q = new TH1D("ht_AK8_notau21_Q",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_Q = new TH1D("ht_AK4_nonb_Q",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_Q = new TH1D("ht_AK8_nonb_Q",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_Q_nj35 = new TH1D("ht_AK4_Q_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_Q_nj35 = new TH1D("ht_AK8_Q_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nodPhi_Q_nj35 = new TH1D("ht_AK4_nodPhi_Q_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nodPhi_Q_nj35 = new TH1D("ht_AK8_nodPhi_Q_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_notau21_Q_nj35 = new TH1D("ht_AK4_notau21_Q_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_notau21_Q_nj35 = new TH1D("ht_AK8_notau21_Q_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_Q_nj35 = new TH1D("ht_AK4_nonb_Q_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_Q_nj35 = new TH1D("ht_AK8_nonb_Q_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_Q_nj6 = new TH1D("ht_AK4_Q_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_Q_nj6 = new TH1D("ht_AK8_Q_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nodPhi_Q_nj6 = new TH1D("ht_AK4_nodPhi_Q_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nodPhi_Q_nj6 = new TH1D("ht_AK8_nodPhi_Q_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_notau21_Q_nj6 = new TH1D("ht_AK4_notau21_Q_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_notau21_Q_nj6 = new TH1D("ht_AK8_notau21_Q_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_Q_nj6 = new TH1D("ht_AK4_nonb_Q_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_Q_nj6 = new TH1D("ht_AK8_nonb_Q_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_T = new TH1D("ht_AK4_noMT_T",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_T = new TH1D("ht_AK8_noMT_T",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_T_nj35 = new TH1D("ht_AK4_T_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_T_nj35 = new TH1D("ht_AK8_T_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_T_nj35 = new TH1D("ht_AK4_noMT_T_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_T_nj35 = new TH1D("ht_AK8_noMT_T_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_T_nj6 = new TH1D("ht_AK4_T_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_T_nj6 = new TH1D("ht_AK8_T_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_T_nj6 = new TH1D("ht_AK4_noMT_T_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_T_nj6 = new TH1D("ht_AK8_noMT_T_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_W = new TH1D("ht_AK4_noMT_W",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_W = new TH1D("ht_AK8_noMT_W",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_W = new TH1D("ht_AK4_nonb_W",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_W = new TH1D("ht_AK8_nonb_W",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_W_nj35 = new TH1D("ht_AK4_W_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_W_nj35 = new TH1D("ht_AK8_W_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_W_nj35 = new TH1D("ht_AK4_noMT_W_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_W_nj35 = new TH1D("ht_AK8_noMT_W_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_W_nj35 = new TH1D("ht_AK4_nonb_W_nj35",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_W_nj35 = new TH1D("ht_AK8_nonb_W_nj35",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_W_nj6 = new TH1D("ht_AK4_W_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_W_nj6 = new TH1D("ht_AK8_W_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_noMT_W_nj6 = new TH1D("ht_AK4_noMT_W_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_noMT_W_nj6 = new TH1D("ht_AK8_noMT_W_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
  ...
  h_ht_AK4_nonb_W_nj6 = new TH1D("ht_AK4_nonb_W_nj6",  ";H_{T}",                  300, 0,3000);
  h_ht_AK8_nonb_W_nj6 = new TH1D("ht_AK8_nonb_W_nj6",  ";H_{T}^{AK8}",            300, 0,3000);
...
*/
  ...
  h_R2_pre = new TH1D("h_R2_pre",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_R2_pre_pass1 = new TH1D("h_R2_pre_pass1",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_R2_pre_pass2 = new TH1D("h_R2_pre_pass2",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_R2_pre_pass3 = new TH1D("h_R2_pre_pass3",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_R2_pre_passj1pt = new TH1D("h_R2_pre_passj1pt",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_R2_pre_passHT = new TH1D("h_R2_pre_passHT",    ";R2_{AK4}",          nbn_R2,bn_R2);
  ...
  h_AK8Jet1Pt_diffBin_GenW_W = new TH1D("AK8Jet1Pt_diffBin_GenW_W",";p_{T, AK8 jet} [GeV]",nbn_AK8J1pt,bn_AK8J1pt);
  h_AK8Jet1Pt_diffBin_GenW_no_W = new TH1D("AK8Jet1Pt_diffBin_GenW_no_W",";p_{T, AK8 jet} [GeV]",nbn_AK8J1pt,bn_AK8J1pt);
  h_AK8Jet1Pt_diffBin_GenTop_Top = new TH1D("AK8Jet1Pt_diffBin_GenTop_Top",";p_{T, AK8 jet} [GeV]",nbn_AK8J1pt,bn_AK8J1pt);
  h_AK8Jet1Pt_diffBin_GenTop_no_Top = new TH1D("AK8Jet1Pt_diffBin_GenTop_no_Top",";p_{T, AK8 jet} [GeV]",nbn_AK8J1pt,bn_AK8J1pt);
...
Analysis::fill_analysis_histos(DataStruct& data, const unsigned int& syst_index, const double& weight)
{
  if (syst_index == 0) {
    ...
    if (apply_all_cuts('Z')) {
      ...
      h_R2_Z->Fill(data.evt.R2, w);
      h_tau21_Z->Fill(tau21.at(0),w);
      h_MET_Z->Fill(data.met.Pt.at(0),w);
      h_R2_MR_Z->Fill(data.evt.MR, data.evt.R2, w);
      h_R2_MET_Z->Fill(data.met.Pt.at(0), data.evt.R2, w);
      ...
      if(nJet>=3 && nJet<6){
        ...
        h_R2_Z_nj35->Fill(data.evt.R2, w);
        h_tau21_Z_nj35->Fill(tau21.at(0),w);
        h_MET_Z_nj35->Fill(data.met.Pt.at(0),w);
        h_R2_MR_Z_nj35->Fill(data.evt.MR, data.evt.R2, w);
      }
      if(nJet>=6){
        ...
        h_R2_Z_nj6->Fill(data.evt.R2, w);
        h_tau21_Z_nj6->Fill(tau21.at(0),w);
        h_MET_Z_nj6->Fill(data.met.Pt.at(0),w);
        h_R2_MR_Z_nj6->Fill(data.evt.MR, data.evt.R2, w);
      }
    }
...
bool iscomFFsim = TString(sample).Contains("TTJets_madgraphMLM");
  if(iscomFFsim){ 
    ...
    if(data.hlt.PFHT800){
      ...
      h_HT_j1pt_pre_passHT->Fill(AK4_Ht,data.jetsAK8.Pt[iJetAK8[0]],w);
    }
    if(data.hlt.AK8PFJet360_TrimMass30){
      ...
      h_HT_j1pt_pre_passj1pt->Fill(AK4_Ht,data.jetsAK8.Pt[iJetAK8[0]],w);
    }
    if(pass1){
      ...
      h_HT_j1pt_pre_pass1->Fill(AK4_Ht,data.jetsAK8.Pt[iJetAK8[0]],w);
    }
    if(pass2){
      ...
      h_HT_j1pt_pre_pass2->Fill(AK4_Ht,data.jetsAK8.Pt[iJetAK8[0]],w);
    }
    if(pass3){
      ...
      h_HT_j1pt_pre_pass3->Fill(AK4_Ht,data.jetsAK8.Pt[iJetAK8[0]],w);
    }
