...
h_ht_AK4Puppi_S->Sumw2();
h_ht_AK8Puppi_S->Sumw2();
h_jet1_pt_S->Sumw2();
h_jet2_pt_S->Sumw2();
h_jet3_pt_S->Sumw2();
h_MR_S->Sumw2();
...
h_ht_AK4Puppi_W->Sumw2();
h_ht_AK8Puppi_W->Sumw2();
h_jet1_pt_W->Sumw2();
h_jet2_pt_W->Sumw2();
h_jet3_pt_W->Sumw2();
h_MR_W->Sumw2();
...
h_ht_AK4Puppi_T->Sumw2();
h_ht_AK8Puppi_T->Sumw2();
h_jet1_pt_T->Sumw2();
h_jet2_pt_T->Sumw2();
h_jet3_pt_T->Sumw2();
h_MR_T->Sumw2();
...
h_ht_AK4Puppi_Q->Sumw2();
h_ht_AK8Puppi_Q->Sumw2();
h_jet1_pt_Q->Sumw2();
h_jet2_pt_Q->Sumw2();
h_jet3_pt_Q->Sumw2();
h_MR_Q->Sumw2();
...
h_tau21_pre->Sumw2();
h_MET_pre->Sumw2();
h_softDropMass_pre->Sumw2();
h_njet_pre_pass->Sumw2();
h_nb_pre_pass->Sumw2();
h_nw_pre_pass->Sumw2();
h_j2_pt_pre_pass->Sumw2();
h_j3_pt_pre_pass->Sumw2();
h_MR_pre_pass->Sumw2();
h_R2_pre_pass->Sumw2();
h_tau21_pre_pass->Sumw2();
h_MET_pre_pass->Sumw2();
h_softDropMass_pre_pass->Sumw2();
h_njet_pre_passj1pt->Sumw2();
h_nb_pre_passj1pt->Sumw2();
h_nw_pre_passj1pt->Sumw2();
h_j2_pt_pre_passj1pt->Sumw2();
h_j3_pt_pre_passj1pt->Sumw2();
h_MR_pre_passj1pt->Sumw2();
h_R2_pre_passj1pt->Sumw2();
h_tau21_pre_passj1pt->Sumw2();
h_MET_pre_passj1pt->Sumw2();
h_softDropMass_pre_passj1pt->Sumw2();
h_njet_pre_passHT->Sumw2();
h_nb_pre_passHT->Sumw2();
h_nw_pre_passHT->Sumw2();
h_j2_pt_pre_passHT->Sumw2();
h_j3_pt_pre_passHT->Sumw2();
h_MR_pre_passHT->Sumw2();
h_R2_pre_passHT->Sumw2();
h_tau21_pre_passHT->Sumw2();
h_MET_pre_passHT->Sumw2();
h_softDropMass_pre_passHT->Sumw2();

  // HT
  h_HT_pre->Sumw2();
  h_HT_pre_pass->Sumw2();
  h_HT_pre_passj1pt->Sumw2();
  h_HT_pre_passHT->Sumw2();
  h_HT_Q->Sumw2();
  h_HT_Q_pass->Sumw2();
  h_HT_Q_passj1pt->Sumw2();
  h_HT_Q_passHT->Sumw2();
  h_HT_S->Sumw2();
  h_HT_S_pass->Sumw2();
  h_HT_S_passj1pt->Sumw2();
  h_HT_S_passHT->Sumw2();
  h_j1_pt_pre->Sumw2();
  h_j1_pt_pre_pass->Sumw2();
  h_j1_pt_pre_passHT->Sumw2();
  h_j1_pt_pre_passj1pt->Sumw2();
  h_j1_pt_Q->Sumw2();
  h_j1_pt_Q_pass->Sumw2();
  h_j1_pt_Q_passHT->Sumw2();
  h_j1_pt_Q_passj1pt->Sumw2();
  h_j1_pt_S->Sumw2();
  h_j1_pt_S_pass->Sumw2();
  h_j1_pt_S_passHT->Sumw2();
  h_j1_pt_S_passj1pt->Sumw2();
  h_HT_j1pt_pre->Sumw2();
  h_HT_j1pt_pre_pass->Sumw2();
  h_HT_j1pt_pre_passHT->Sumw2();
  h_HT_j1pt_pre_passj1pt->Sumw2();
  h_HT_j1pt_Q->Sumw2();
  h_HT_j1pt_Q_pass->Sumw2();
  h_HT_j1pt_Q_passHT->Sumw2();
  h_HT_j1pt_Q_passj1pt->Sumw2();
  h_HT_j1pt_S->Sumw2();
  h_HT_j1pt_S_pass->Sumw2();
  h_HT_j1pt_S_passHT->Sumw2();
  h_HT_j1pt_S_passj1pt->Sumw2();
  h_HT_j1pt_T->Sumw2();
  h_HT_j1pt_T_pass->Sumw2();
  h_HT_j1pt_T_passHT->Sumw2();
  h_HT_j1pt_T_passj1pt->Sumw2();
  h_HT_j1pt_W->Sumw2();
  h_HT_j1pt_W_pass->Sumw2();
  h_HT_j1pt_W_passHT->Sumw2();
  h_HT_j1pt_W_passj1pt ->Sumw2();
}
